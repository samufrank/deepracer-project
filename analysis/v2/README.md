...
Speed-curvature matching:  
  - <15 deg (straight): 1.5x bonus if speed >3.0, 0.7x penalty if speed <2.0  
  - 15-50 deg (moderate): 1.3x bonus for 2.0-3.5 m/s, 0.8x penalty if >3.5  
  - >50 deg (sharp): 1.4x bonus if speed <2.5, 0.6x penalty if >3.0  
...
Action space: Speed 1.0-4.0 m/s (accidentally changed from 0.5-4.0), steering +/- 30 deg  
...
4. Curvature thresholds (15 deg / 50 deg) may be miscalibrated
